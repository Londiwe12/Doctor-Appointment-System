    ...
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="main-nav" class="collapse navbar-collapse">
        <ul class="nav navbar-nav" id="mainNav">
		  <li class="active" id="firstLink"><a href="myDetails.php" class="scroll-link">My Profile</a></li>
          <li  id="firstLink"><a href="myAppoinment.php" class="scroll-link">My Appointments</a></li>
          <li><a href="myCustomer.php" class="scroll-link">My Patients</a></li>
