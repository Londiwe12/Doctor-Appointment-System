...
<section id="home">
<div class="container">
<br/><br/><div class="row flat" >
     <br/> <br/><div class="col-lg-3 col-md-3 col-xs-12">
        <ul class="plan plan1">
          <li class="plan-name">Patient </li>
          
          <li class="plan-action"> <a href="patient_login.php" class="btn btn-danger btn-lg">Signin</a> </li>
        </ul>
      </div>
	  <div class="col-lg-3 col-md-3 col-xs-12">
        <ul class="plan plan1">
          <li class="plan-name">Counsellor </li>
          
          <li class="plan-action"> <a href="doctors/doctorlogin.php" class="btn btn-danger btn-lg">Signin</a> </li>
        </ul>
      </div>
	  <div class="col-lg-3 col-md-3 col-xs-12">
        <ul class="plan plan1">
          <li class="plan-name">Admin </li>
          
          <li class="plan-action"> <a href="admin/index.php" class="btn btn-danger btn-lg">Signin</a> </li>
        </ul>
      </div>
</div>
</section>
