    ...
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="main-nav" class="collapse navbar-collapse">
        <ul class="nav navbar-nav" id="mainNav">
		  <li class="active" id="firstLink"><a href="" class="scroll-link">Dashboard</a></li>
          <li  id="firstLink"><a href="search_doctor.php" class="scroll-link">Search Doctors</a></li>
          <li><a href="view_booking.php" class="scroll-link">View Booking</a></li>
          <li><a href="changepwd.php" class="scroll-link">change Password</a></li>
          <li><a href="feedback.php" class="scroll-link">Feedback</a></li>
		  <li><a href="myDetails.php" class="scroll-link">PROFILE</a></li>
